...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SMARTASSARMANI)
extern struct cpufreq_governor cpufreq_gov_smartassarmani;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_smartassarmani)
