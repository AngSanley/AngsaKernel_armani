/*
 * drivers/cpufreq/cpufreq_smartass_armani.c
 *
 ...
 * Adapted by Stanley "AngSanley" for Redmi 1S
 * Performance Version
 *
 */
...
static int cpufreq_governor_smartass_armani(struct cpufreq_policy *policy,
		unsigned int event);

#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_SMARTASSARMANI
static
#endif
struct cpufreq_governor cpufreq_gov_smartass_armani = {
	.name = "smartassarmani",
	.governor = cpufreq_governor_smartass_armani,
...
static int cpufreq_governor_smartass_armani(struct cpufreq_policy *new_policy,
		unsigned int event)
{
...
static int __init cpufreq_smartass_init(void)
{
	...
	return cpufreq_register_governor(&cpufreq_gov_smartass_armani);
}

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_SMARTASSARMANI
...
{
	cpufreq_unregister_governor(&cpufreq_gov_smartass_armani);
...
MODULE_DESCRIPTION ("'cpufreq_smartassarmani' - A smart cpufreq governor");
MODULE_LICENSE ("GPL");
